...
PERSIST_DIR = os.environ.get("PERSIST_DIR", "./data/chroma_juego_db_v2")
...
def build_or_load_vectorstore(pdf_path: str, persist_dir: str):
    ...
    # Si existe el directorio de persistencia con datos, cargamos
    ...
    # Si no, construimos desde el PDF
...
def build_chain():
    ...
    def format_context(docs):
        ...
        # Limitar contexto a ~4k chars para evitar prompts enormes
        return "\n\n".join(parts)[:4000]
    ...
    prompt_template = (
        ...
        'Si no está en el contexto, responde: "No cuento con la informacion requerida, quieres volver a preguntar?."\n\n'
        "Contexto: {context}\n"
        "Pregunta: {question}\n"
        "Respuesta:"
    )
